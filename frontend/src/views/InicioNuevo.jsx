...
export default function InicioNuevo() {
  ...
  "
                ...
                <div className="absolute inset-0 flex justify-center z-20 pointer-events-none pt-20 md:pt-32">
                    <p className="text-white text-2xl md:text-4xl font-bold opacity-80 md:mb-16">
                        Tu Banner Aquí
                    </p>
                </div>
...
">
    ...
    ">
            ...
            <div className="relative z-10 overflow-hidden whitespace-nowrap bg-gradient-to-r from-black via-[#0B0608] to-black py-2 -mt-6 md:py-2 md:mt-0">
                {/* TRACK con 2 grupos idénticos → loop perfecto */}
                <div className="marquee-track will-change-transform">
                    {/* Grupo 1 */}
                    <div className="marquee-group">
                        <span className="text-white text-lg md:text-1xl font-semibold mx-[40px]">
                            Tus cuotas sin interés<span className="mx-6">•</span>Descuentos Pago Efectivo / Transferencia
                        </span>
                        <span className="text-white text-lg md:text-1xl font-semibold mx-[40px]">
                            Tus cuotas sin interés<span className="mx-6">•</span>Descuentos Pago Efectivo / Transferencia
                        </span>
